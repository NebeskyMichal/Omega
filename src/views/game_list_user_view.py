...
class GameUserListView:
    ...
    def __init__(self, data):
        ...
        rating_label = Label(table_frame, text="User rating", font=("Arial", 14), padx=10, pady=10)
        rating_label.grid(row=0, column=1, sticky=W)

        rating_label = Label(table_frame, text="User review", font=("Arial", 14), padx=10, pady=10)
        rating_label.grid(row=0, column=2, sticky=W)
        ...
        for i, row in enumerate(data):
            ...
            rating_label = Label(table_frame, text=str(text), font=("Arial", 12), padx=10, pady=5)
            rating_label.grid(row=i + 1, column=2, sticky=W)
